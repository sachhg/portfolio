    ...
    stations: [
      {
        ...
        position: [180, 120],
        description: 'Distributed cloud platform — 10K+ deploys/day, 99.9% uptime',
      ...
      },
      {
        ...
        name: 'Data Pipeline',
        position: [260, 120],
        description: 'Real-time streaming pipeline — 2M+ events/sec, ML anomaly detection',
      ...
      },
      {
        ...
        name: 'ML Dashboard',
        position: [340, 120],
        description: 'ML model monitoring — real-time drift detection & A/B analysis',
      ...
      },
      {
        ...
        name: 'API Gateway',
        position: [420, 120],
        description: 'Custom API gateway — 50K req/s, 40% p99 latency reduction',
      ...
      },
      {
        ...
        name: 'DevTools Suite',
        position: [500, 120],
        description: 'Developer CLI tools & VS Code extensions — used by 200+ engineers',
    ...
    stations: [
      {
        ...
        name: 'Mobile App',
        position: [200, 60],
        description: 'Cross-platform mobile app — 50K+ downloads, 4.7★ rating',
      ...
      },
      {
        ...
        name: 'Design System',
        position: [320, 180],
        description: '60+ component design system — adopted by 12 teams, 35% faster UI dev',
      ...
      },
      {
        ...
        name: 'Search Engine',
        position: [380, 240],
        description: 'Hybrid full-text + vector search — fuzzy matching & personalized ranking',
    ...
    stations: [
      {
        ...
        name: 'Chain Explorer',
        position: [140, 180],
        description: 'Real-time blockchain explorer — sub-second block indexing & analytics',
      ...
      },
      {
        ...
        position: [200, 180],
        description: 'Cross-chain asset bridge — atomic swaps with multi-sig validation',
      ...
      },
      {
        ...
        name: 'Viz Studio',
        position: [340, 40],
        description: 'Drag-and-drop viz builder — 20+ chart types, real-time data',
    ...
    stations: [
      {
        ...
        position: [700, 100],
        description: 'Senior SWE — led 6-engineer team, 10x deployment frequency',
      ...
      },
      {
        ...
        position: [780, 100],
        description: 'Growth team SWE — 200+ A/B tests, 25% engagement lift via ML recs',
      ...
      },
      {
        ...
        position: [860, 100],
        description: 'Platform team dev — shipped features to millions in first 6 months',
      ...
      },
      {
        ...
        position: [940, 100],
        description: 'SWE Intern — built analytics dashboard adopted as key team tool',
    ...
    stations: [
      {
        ...
        name: 'Open Source',
        position: [720, 40],
        description: 'OSS maintainer — 5K+ star utility library, meetup speaker',
      ...
      },
      {
        ...
        name: 'Freelance',
        position: [840, 160],
        description: 'Freelance consultant — 10+ startups, MVPs to production scaling',
      ...
      },
      {
        ...
        name: 'Teaching Asst',
        position: [900, 220],
        description: 'CS Teaching Assistant — led labs for 40+ students, automated grading',
    ...
    stations: [
      {
        ...
        name: 'Hackathon Wins',
        position: [720, 160],
        description: '3x hackathon winner — HackMIT, TreeHacks, AR & collab tools',
      ...
      },
      {
        ...
        name: 'Research Asst',
        position: [840, 40],
        description: 'HCI research assistant — co-authored CHI 2020 paper on gestures',
    ...
    stations: [
      {
        ...
        name: 'University',
        position: [180, 420],
        description: 'B.S. Computer Science — 3.8 GPA, Dean\'s List, Honors',
      ...
      },
      {
        ...
        name: 'Algorithms',
        position: [260, 420],
        description: 'Graduate-level algorithms — graph, approximation, randomized',
      ...
      },
      {
        ...
        name: 'Systems',
        position: [340, 420],
        description: 'Distributed Systems — consensus, replication, built Raft impl',
      ...
      },
      {
        ...
        position: [420, 420],
        description: 'ML fundamentals — CNN for medical imaging, 94% accuracy',
      ...
      },
      {
        ...
        name: 'Capstone',
        position: [500, 420],
        description: 'Senior capstone — won Best Technical Achievement, adopted by dept',
    ...
    stations: [
      {
        ...
        position: [200, 360],
        description: '12-week intensive — 5 full-stack apps, React to AWS deployment',
      ...
      },
      {
        ...
        name: 'Databases',
        position: [320, 480],
        description: 'Database internals — built B+ tree storage engine from scratch',
      ...
      },
      {
        ...
        name: 'Security',
        position: [380, 480],
        description: 'Computer Security — crypto, web security, CTF competitor',
    ...
    stations: [
      {
        ...
        name: 'Online Courses',
        position: [200, 480],
        description: '20+ courses on Coursera, edX & MIT OCW — quantum to finance',
      ...
      },
      {
        ...
        name: 'Certifications',
        position: [320, 360],
        description: 'AWS SA Pro, CKA, GCP Data Engineer — active certifications',
    ...
    stations: [
      {
        ...
        name: 'Languages',
        position: [680, 400],
        description: 'TypeScript, Python, Go, Rust — exploring Zig & Gleam',
      ...
      },
      {
        ...
        name: 'Frontend',
        position: [760, 400],
        description: 'React expert — Next.js, Remix, WebGL, Canvas, SVG viz',
      ...
      },
      {
        ...
        name: 'Backend',
        position: [840, 400],
        description: 'Node.js, Django, Go — PostgreSQL, Redis, Kafka, RabbitMQ',
      ...
      },
      {
        ...
        name: 'DevOps',
        position: [920, 400],
        description: 'K8s, Terraform, CI/CD — AWS, GCP, Azure, Datadog, Grafana',
    ...
    stations: [
      {
        ...
        name: 'Photography',
        position: [700, 340],
        description: 'Street & landscape — Fujifilm X-T5, gallery-featured work',
      ...
      },
      {
        ...
        name: 'Music',
        position: [820, 460],
        description: 'Lo-fi producer & fingerstyle guitarist — creative outlet',
      ...
      },
      {
        ...
        name: 'Running',
        position: [880, 460],
        description: '3 marathons, 10+ halfs — PR 3:28, thinking through miles',
    ...
    stations: [
      {
        ...
        name: 'Tech Writing',
        position: [700, 460],
        description: 'Technical blog — 50K+ monthly readers, guest posts on major pubs',
      ...
      },
      {
        ...
        name: 'AI / ML',
        position: [820, 340],
        description: 'LLMs, RAG, PyTorch — built code review assistant & AI search',
      ...
      },
      {
        ...
        name: 'Open Source',
        position: [920, 340],
        description: 'OSS contributor & mentor — welcoming project cultures',
